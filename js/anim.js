...
(function earth() {
    ...
    (async () => {
        await flod('js/mod/wep/scene.gltf').then(gltf => {
    ...
    const contr = new ArcballControls(cam, rend.domElement, scene);
    contr.enableZoom = false;
    contr.enablePan = false;
    contr.autoAnimations = true;
    contr.rotateSpeed = 0.1;
